...
@section('content')
    <div class="d-flex mx-3">
        ...
        @enddesktop
        <h1 class="fs-5 my-3">{{ fs_config('channel_nearby_comments_name') }}</h1>
    </div>
                ...
                $('#currentLocation').html(`
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('fresns.nearby.comments') }}" role="button" class="btn btn-success"><i class="fa-solid fa-map-location-dot"></i> {{ fs_lang('reloadLocation') }}</a>
                        </div>
                    </div>`)
            }
        }
