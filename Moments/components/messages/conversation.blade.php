<a href="{{ route('fresns.conversation.detail', ['uidOrUsername' => $conversation['user']['fsid']]) }}" class="list-group-item list-group-item-action border-end-0 border-start-0 d-flex justify-content-between position-relative">
